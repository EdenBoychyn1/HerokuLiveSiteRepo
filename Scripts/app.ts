...
(function()
{
    ...
    function LoadLink(link: string, data: string = ""): void
    {
        ...
        // Changes what appears on the URL. 
        history.pushState({}, "", router.ActiveLink);

        // Capitalize Active Link and sets Document title to it.
        // Change document title to login
    ...
    function AddNavigationEvents(): void
    {
        ...
        // Have to manage. Everytime there is an "on" you are adding an event listener to the queue. 
        // therfore queue will be filled with event listeners which slows down the website.
        NavLinks.off("click");
        NavLinks.off("mosueover");

         // It will loop through each anchor tag/ nav link
        NavLinks.on("click", function()
        {
            // Load Link for whatever one we clicked.
            // depending on which 1 I click it will load appriopriate content 
            LoadLink($(this).attr("data") as string);
        });

        // When mouse over any of the links
        NavLinks.on("mouseover", function()
        {
            // Only when I mouseover my cursor becomes a pointer.
    ...
    {
        // Look for all "data=register" < example
    ...
    function DisplayLoginPage(): void
    {
        ...
        // Because there is a register link, we have to use AddEventListener for the register button on login
