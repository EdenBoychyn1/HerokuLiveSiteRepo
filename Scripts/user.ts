namespace core
{
    export class User
    {
        ...
        // method overrides
        /**
         * This method overrides the built-in toString method and returns a comma-seperated string containing the object's property values
         *
         * @return {string} 
         */
        toString(): string
        ...
        /**
         * This method converts the object's properties into a comma-seperated string.
         *
         * @return {(string | null)} 
         * @memberof User
         */
